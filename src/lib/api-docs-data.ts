...
export const schoolAdminModules: CrudModule[] = [
  ...
  },
  {
    label: "ICSE",
    endpoints: [
      { path: "icse/admit-card", table: "icse_admit_cards", desc: "Admit cards", params: ["exam_id"] },
      { path: "icse/assessments", table: "icse_assessments", desc: "Assessments", params: ["class_id", "section_id", "subject_id", "exam_id"] },
      { path: "icse/exam", table: "icse_exams", desc: "ICSE exams", params: ["class_id", "section_id"] },
      { path: "icse/exam-attendance", table: "icse_exam_attendance", desc: "Exam attendance", params: ["exam_id", "class_id", "section_id"] },
      { path: "icse/exam-grades", table: "icse_exam_grades", desc: "Exam grades", params: ["exam_id", "class_id"] },
      { path: "icse/exam-marks", table: "icse_exam_marks", desc: "Exam marks", params: ["exam_id", "class_id", "section_id", "subject_id"] },
      { path: "icse/exam-students", table: "icse_exam_students", desc: "Exam students", params: ["exam_id", "class_id", "section_id"] },
      { path: "icse/exam-subjects", table: "icse_exam_subjects", desc: "Exam subjects", params: ["exam_id", "class_id"] },
      { path: "icse/marksheet", table: "icse_marksheets", desc: "Marksheets", params: ["exam_id", "class_id", "section_id", "student_id"] },
      { path: "icse/observation", table: "icse_observations", desc: "Observations", params: ["class_id", "section_id", "subject_id"] },
      { path: "icse/obs-params", table: "icse_observation_params", desc: "Observation params", params: ["observation_id"] },
      { path: "icse/reports", table: "icse_reports", desc: "ICSE reports", params: ["exam_id", "class_id", "section_id"] },
      { path: "icse/schedule", table: "icse_schedules", desc: "Exam schedules", params: ["exam_id", "class_id"] },
      { path: "icse/settings", table: "icse_settings", desc: "ICSE settings", params: ["academic_year"] },
      { path: "icse/template", table: "icse_templates", desc: "Templates", params: ["type"] },
      { path: "icse/terms", table: "icse_terms", desc: "ICSE terms", params: ["academic_year"] },
      { path: "icse/custom-marksheet", table: "icse_custom_marksheets", desc: "ICSE custom marksheet (clone of CBSE custom_marksheet)", params: ["student_id", "session_id"], methods: ["GET", "POST"] },
      { path: "icse/custom-marksheet-entry", table: "icse_custom_marksheets", desc: "ICSE custom marksheet entry (clone of CBSE custom_marksheet_entry)", params: ["class_id", "section_id", "session_id"], methods: ["GET", "POST"] },
    ],
  },
  {
    label: "Certificate",
