...
export default function DailyCollectionReportPage() {
  ...
  const rows = useMemo(
    () => fees.filter((r) => (r.paymentDate ? String(r.paymentDate).slice(0, 10) === date : false)),
    [fees, date]
  )
  ...
  return (
    <div className="space-y-6">
      <ReportBanner title="Daily Collection Report" subtitle="Reports / Finance / Daily Collection Report" />
      ...
      <TableCard title={`Daily Collection Report (${rows.length})`} action={<PrintButtons />}>
