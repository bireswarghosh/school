...
export default function MyLeaveRequestReportPage() {
  ...
  return (
    <div className="space-y-6">
      <ReportBanner title="My Leave Request Report" subtitle="Reports / Human Resource / My Leave Request Report (My Requests)" />
      ...
      <TableCard title={`My Leave Request Report (${filtered.length})`} action={<PrintButtons />}>
