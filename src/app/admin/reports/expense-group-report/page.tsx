...
export default function ExpenseGroupReportPage() {
  ...
  const grouped = useMemo(() => {
    ...
    for (const r of expenses) {
      const key = headName(r.expenseHead)
  ...
  return (
    <div className="space-y-6">
      <ReportBanner title="Expense Group Report" subtitle="Reports / Finance / Expense Group Report" />

      <TableCard title={`Expense Group Report (${grouped.length})`} action={<PrintButtons />}>
