...
const reportData: LiveMeetingReport[] = [
  { id: 1, title: "Staff Planning Meeting", date: "07/03/2026", duration: "60 min", totalJoined: 3, joinedStaff: [
    { name: "John Doe", role: "Teacher" }, { name: "Jane Smith", role: "Teacher" }, { name: "Robert Wilson", role: "Teacher" },
  ]},
  { id: 2, title: "Parent Teacher Meeting", date: "07/05/2026", duration: "120 min", totalJoined: 2, joinedStaff: [
    { name: "Emily Davis", role: "Teacher" }, { name: "Michael Brown", role: "Accountant" },
  ]},
  { id: 3, title: "Department Heads Meeting", date: "07/01/2026", duration: "45 min", totalJoined: 3, joinedStaff: [
    { name: "John Doe", role: "Teacher" }, { name: "Sarah Johnson", role: "Librarian" }, { name: "David Miller", role: "Admin" },
  ]},
]
...
export default function LiveMeetingReportPage() {
  const [viewJoinList, setViewJoinList] = useState<LiveMeetingReport | null>(null)

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-800">Live Meeting Report</h2>
        <p className="text-sm text-gray-500 mt-1">Gmeet Live Classes / Live Meeting Report</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                {["#", "Meeting Title", "Date", "Duration", "Total Joined", "Action"].map((h) => (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="text-left px-3 py-2 font-medium text-gray-600 text-xs uppercase tracking-wider">Role</th>
                  </tr>
                </thead>
                <tbody>
