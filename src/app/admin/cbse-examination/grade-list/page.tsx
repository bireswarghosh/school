...
export default function CbseGradeListPage() {
  const { data: examGrades, add, update, remove, loading } = useApi<ExamGrade>("/api/cbse/exam-grades")
    ...
    <div className="space-y-5">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[var(--primary)] to-[var(--primary)]/80 px-6 py-4 shadow-sm">
        <div className="relative z-10">
          ...
          <p className="text-xs text-[var(--primary)]/80 mt-0.5">CBSE Examination / Grade List</p>
        </div>
      </div>
