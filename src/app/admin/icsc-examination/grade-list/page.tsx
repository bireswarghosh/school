...
export default function IcscGradeListPage() {
  const { data: examGrades, add, update, remove, loading } = useApi<ExamGrade>("/api/icsc/exam-grades")
    ...
    <div className="space-y-5">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[var(--primary)] to-[var(--primary)]/80 px-6 py-4 shadow-sm">
        <div className="relative z-10">
          ...
          <p className="text-xs text-[var(--primary)]/80 mt-0.5">ICSC Examination / Grade List</p>
        </div>
      </div>
